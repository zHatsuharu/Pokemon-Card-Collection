                        ...
                        <div>
                            ...
                            >
                                ...
                                <TableBody>
                                    <TableRow key={1}>
                                        ...
                                        <TableCell>{card.tcgplayer && card.tcgplayer.updatedAt}</TableCell>
                                        <TableCell>
                            ...
                            >
                                ...
                                <TableRow key={1}>
                                    ...
                                    <TableCell>{card.cardmarket && card.cardmarket.prices.lowPrice}</TableCell>
                                    <TableCell>{card.cardmarket && card.cardmarket.prices.trendPrice}</TableCell>
                                    <TableCell>
                                        {card.cardmarket && 
                                            <Link
                                                isExternal
